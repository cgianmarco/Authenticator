...
class TestUserService:
    ...
    def test_register_ok(self):
        ...
        self.user_service.user_repository.find_user_by_email = Mock(return_value=None)
        self.user_service.user_repository.add_user = Mock()

        self.user_service.register(userRegister)
    ...
    def test_register_throws_error_when_user_already_exists(self):
        userRegister = UserRegister(
            email="prova@gmail.com", password="password", enable_tfa=False
        )
        ...
        self.user_service.user_repository.find_user_by_email = Mock(
    ...
    def test_login_throws_error_when_user_does_not_exists(self):
        userLogin = UserLogin(email="prova@gmail.com", password="password")
    ...
    def test_authenticate_otp_ok(self):
        ...
        self.user_service.validate_otp(otpValidation)
        self.user_service.jwtAuth.generate_access_token.assert_called_once()

    def test_authenticate_otp_throws_error_when_user_does_not_exist(self):
        otpValidation = OTPValidation(email="prova@gmail.com", otp="123456")
